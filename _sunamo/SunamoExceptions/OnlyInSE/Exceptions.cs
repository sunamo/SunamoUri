namespace SunamoUri._sunamo.SunamoExceptions.OnlyInSE;
...
internal class Exceptions
{
    ...
    internal static string NotImplementedCase(string before, object niCase)
    {
        ...
        return CheckBefore(before) + "Not implemented case" + fr +
               " . internal program error. Please contact developer" +
               ".";
    }
    ...
    internal static string CannotCreateDateTime(string v, int year, int month, int day, int hour, int minute,
        int seconds,
        Exception ex)
    {
        return v +
